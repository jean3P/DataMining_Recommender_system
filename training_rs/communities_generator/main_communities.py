...
import community
import random
from constants import large_twitch_edges, large_twitch_features, communities_path
...
def save_communities_to_csv(partition, filename, subset_filename):
    ...
    filename_path = os.path.join(communities_path, filename)
    subset_filename_path = os.path.join(communities_path, subset_filename)
